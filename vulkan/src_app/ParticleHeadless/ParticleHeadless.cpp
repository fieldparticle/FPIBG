...
int ParticleHeadless(PerfObj* perObj, TCPObj* tcp)
{
	...
	ImageDepth* imageDepth 	= new ImageDepth(vulkanObj, "DepthImage");
	ImageColor* imageColor	= new ImageColor(vulkanObj, "ColorImage");
	RenderPassHeadless* renderPass = new RenderPassHeadless(vulkanObj, "RenderPassHeadless");
		
	PipelineGraphicsHeadless* pipelineGraphicsParticle
		= new PipelineGraphicsHeadless(vulkanObj, "Graphics Pipeline Particle");

	PipelineComputeParticle* pipelineComputeParticle
		= new PipelineComputeParticle(vulkanObj, "Compute Pipeline Particle");


	FrameBufferHeadless* frameBuffer = new FrameBufferHeadless(vulkanObj, "FrameBuffer");
	...
	renderPass->Create(swapChain,{imageColor,imageDepth});
