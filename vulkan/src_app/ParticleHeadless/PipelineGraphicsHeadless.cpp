...
void PipelineGraphicsHeadless::CreatePipeline()
{
   ...
   // rasterizer.polygonMode 				= VK_POLYGON_MODE_FILL;
	...
	{
        throw std::runtime_error("PipelineGraphicsHeadless::CreatePipeline failed at vkCreatePipelineLayout");
    }
	...
	if(vkCreatePipelineCache(m_App->GetLogicalDevice(), &pipelineCacheCreateInfo, nullptr, &m_PipelineCache) != VK_SUCCESS)
    {
        throw std::runtime_error("PipelineGraphicsHeadless::CreatePipeline failed at vkCreatePipelineCache");
    }
